...
public class PHONGBAN {
	...
	public void nhapPhongBan() {
		...
		this.maTruongPhong=test.st.nextLine();
		System.out.print("Ma phong ban -> ");
		this.maPhongBan=test.st.nextLine();
		System.out.print("So luong nhan vien -> ");
		this.soLuongNhanVien=Integer.parseInt(test.in.nextLine());
		System.out.print("Ten Phong Ban -> ");
		this.tenPhongBan=test.st.nextLine();
		System.out.print("So du an thuc hien -> ");
		this.soDuAnThucHien=Integer.parseInt(test.in.nextLine());
	}
